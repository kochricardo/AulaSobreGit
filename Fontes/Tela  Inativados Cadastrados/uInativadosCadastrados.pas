...
begin
  ...
  TFloatField(_cdsInativadosCadastrados.FieldByName('VT_PCO_FORNECEDOR')).DisplayLabel:='Vlr.Compradas(Pço Fornec.)';
  ...
  TFloatField(_cdsInativadosCadastrados.FieldByName('VT_PCO_CUSTO')).DisplayLabel:='Vlr.Compradas(Pço.Custo)';
