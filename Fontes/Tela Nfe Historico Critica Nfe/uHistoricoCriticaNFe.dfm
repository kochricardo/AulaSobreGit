object _frmNfeHistoricoCriticaNFe: T_frmNfeHistoricoCriticaNFe
  Left = 192
  Top = 107
  ...
  object SQLCapaCritica: TSQLQuery
    ...
    SQL.Strings = (
        ...
        'eracao,ds_observacao_solucionador'
      
        'from prddm.dc_compra_critica_entrada C,prddm.dc_compra_situacao_' +
        'divergencia S'
      
        'where C.cd_compra_situacao_critica = S.cd_compra_situacao_diverg' +
        'encia'
    ...
    Left = 208
    Top = 72
    object SQLCapaCriticaSQ_ORDEM: TFMTBCDField
      FieldName = 'SQ_ORDEM'
      Required = True
      Precision = 6
      Size = 0
    ...
    object SQLCapaCriticaDS_COMPRA_SITUACAO_DIVERGENCIA: TWideStringField
      FieldName = 'DS_COMPRA_SITUACAO_DIVERGENCIA'
      Required = True
      Size = 40
    end
    ...
    object SQLCapaCriticaDS_OBSERVACAO_SOLUCIONADOR: TWideStringField
  ...
  object CDSCapaCritica: TClientDataSet
    ...
    Left = 288
    Top = 72
    object CDSCapaCriticaSQ_ORDEM: TFMTBCDField
      FieldName = 'SQ_ORDEM'
      Required = True
      Precision = 6
      Size = 0
    ...
    object CDSCapaCriticaDS_COMPRA_SITUACAO_DIVERGENCIA: TWideStringField
      FieldName = 'DS_COMPRA_SITUACAO_DIVERGENCIA'
      Required = True
      Size = 40
    end
    ...
    object CDSCapaCriticaDS_OBSERVACAO_SOLUCIONADOR: TWideStringField
      FieldName = 'DS_OBSERVACAO_SOLUCIONADOR'
      Required = True
      Size = 200
    end
