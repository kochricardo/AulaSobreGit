...
//    add('       ,(EM.QT_FISICO - QT_RESERVADO- QT_RESERVA_PROBLEMATICA - QT_VENCIDO)');
    ...
    add(' ORDER BY 1');
     stQuery.SaveToFile('c:\temp\RelacaoPosição EstoqueCD.sql');
   end;
...
begin
 ...
 begin
  ...
  TStringField(_cdsDetalheEstoque.FieldByName('DS_APRESENTACAO_MERCADORIA')).DisplayLabel:='Apresentação';
...
begin
 ...
 GerarTabelaArquivoCVS(_cdsDetalheEstoque,'Relatorio Estoque por Centro Distribuição',  nmArquivo);
