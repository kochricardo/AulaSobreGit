...
begin
 ...
 TStringField(_cdsPedido.FieldByName('OBSP_P')).DisplayLabel:='Observação';
  ...
  case key of
    ...
    VK_F10 : begin
             ...
             begin
              ...
              begin
                if  Confirma('Pedido Já possui Item faturado no Laboratorio...'+#13+
              ...
              begin
                if Confirma('Este pedido Tem um Pedido Vinculado a ele'+#13+
                            'Deseja Cancelar Este Pedido Também?',MB_DEFBUTTON2)=IDYES then
                 begin
      ...
      VK_RETURN: begin
                 ...
                 begin
                  ...
                  if  _cdsItemPedido.FieldByName('nr_operador_logistico').AsInteger>1 then
                      ...
                      begin
                           Mensagem('Pedido Operação Logistica não pode direcionar para verba!!!',16);
                           exit;
                      end;
                  ...
                  begin
                   ...
                   begin
                      Mensagem('Verba Não Cadastrada para este Fornecedor !!!!',64);
                     _cdsItemPedido.FieldByName('NRVV_Y').AsInteger:=0;
                     exit;
                   end;
                  end;
                  ...
                  begin
                    Mensagem('Item Não pode ser modificado',48);
...
try
     ...
     try
       ...
       on E:Exception do
      begin
          Application.MessageBox(pchar(format('Aconteceu um erro desconhecido durante a conversão'+
...
begin
  ...
  begin
    ...
    nrLinha:=TopoPaginaPedido(nrPag, nrLinha, nrPedido,DadosValoresPedido.dtPedido,'',DadosCD.stENDERECO+' Nº. '+INTTOSTR(DadosCD.nrLogradouro),
