...
type
  ...
  private
    ...
    procedure MostraHistoricodePedidoRS(nrLaboratorio, nrProduto: Integer;
      idHistorico: Boolean);
    procedure SetCamposSugestaoIdeal(vlSugestãoIdealSC,
      vlSugestãoIdealRS: Double);
    procedure SetCamposSugestaoPossivel(vlSugestãoPossivelSC,
    ...
    procedure SetCamposSugestaoIdealGrid(vlSugestãoIdealGrid,
      vlSugestãoPossivelGrid: Double);
...
begin
  ...
  _stbCompras.Panels[1].Text := 'Abrindo Historico de Estoque do Laboratório';
  _stbCompras.Refresh;
...
begin
  try
    ...
    begin
      ...
      begin
        Mensagem('Este labaratório não possue Grupo Válido' + #13 +
          'Grupo = frequencia de Compra ' + #13 + ' 1 = 28 dias' + #13 +
          ' 2 = 14 dias' + #13 + ' 4 = 07  dias' + #13 + ' 8 = 3,5 dias' + #13 +
          'Para este pedido Sistema Usará Grupo 1', MB_ICONEXCLAMATION);
      ...
      begin
        Mensagem('Este labaratório não possue Dia Agendado' + #13 +
          'Para este pedido Sistema Usará Dia de Hoje como dia Agendado', 48);
      ...
      _stbCompras.Panels[1].Text :=
        'Abrindo Parametros de Compra do Laboratório';
      _stbCompras.Refresh;
      AbreParamentoCompraLaboratorio (_cdsLaboratorio.FieldByName('CD_GRUPO_CURVA_FABRICANTE').AsInteger);
      _stbCompras.Panels[1].Text :='Abrindo Cadastro de produto do Laboratório';
      _stbCompras.Refresh;
      ...
      _stbCompras.Panels[1].Text := 'Abrindo Vendas do Laboratório';
      _stbCompras.Refresh;
      ...
      _stbCompras.Panels[1].Text := 'Abrindo Lista de Preço do Laboratório';
      _stbCompras.Refresh;
      ...
      // _stbCompras.Panels[1].Text :=
      // 'Abrindo Historico de Estoque do Laboratório';
      // _stbCompras.Refresh;
      // AbreEstoqueDiario(_nrLaroratorio);
      _stbCompras.Panels[1].Text := 'Abrindo Pendencia do Laboratório';
      _stbCompras.Refresh;
      ...
      _stbCompras.Panels[1].Text := 'Abrindo Ultimas Compras do Laboratório';
      _stbCompras.Refresh;
      _cdsUltimasCompra := AbreUltimasCompraLaboratorio(nrLaboratorio,
        cdoperadorLogisticoPedido, cdoperadorLogisticoPedido);
      _stbCompras.Panels[1].Text :=
        'Abrindo Indice de Falta Anterior do Laboratório';
      _stbCompras.Refresh;
      ...
      begin
        ...
        _stbCompras.Panels[1].Text :=
          'Abrindo Indice de Falta Atual do Laboratório';
        _stbCompras.Refresh;
      ...
      _stbCompras.Panels[1].Text := 'Montando Previsão de compra...';
      _stbCompras.Refresh;
      if idPedido > 0 then
    ...
    vk_return:
      begin
        ...
        begin
          ...
          // CriaGradeProduto;
          _stbCompras.Panels[1].Text := 'Abrindo Laboratório';
          if _cdsProduto.Active then
          ...
          _stbCompras.Panels[1].Text := 'Abrindo Vendas CD Tubarão...';
          _stbCompras.Repaint;
          _cdsVendaAnualLaboratorioSC := AbreVendaLaboratorioAnual
            (nrLaboratorioLocal, 1);

          _stbCompras.Panels[1].Text := 'Abrindo indice preço...';
          _stbCompras.Repaint;
  ...
  case Key of
    vk_return:
      begin
        ...
        begin
          Mensagem('Verba Não Cadastrada', 16);
        ...
        begin
          Mensagem('Pedido de Operação Logistica não Pode ter recurso' + #13 +
    ...
    vk_return:
      begin
        ...
        begin
          ...
          begin
            Mensagem('Preço Não Encontrado Para Este produto No CD ' +
              _edtCD.Text, 64);
            _lbeQuantidadePedidoGrid.SetFocus;
            exit;
          end;
...
begin
  ...
  begin
    ...
    TFloatField(_cdsPrePedido.FieldByName('ABTY_Y')).DisplayLabel :='Desc.Padrão';
    ...
    TFloatField(_cdsPrePedido.FieldByName('PUNY_Y')).DisplayLabel :='Preço Unit.';
...
procedure T_frmCompras.SetCamposSugestaoIdeal(vlSugestãoIdealSC,
  vlSugestãoIdealRS: Double);
begin

  _lbeSugestaoIdealSC.Text := FormatFloat('###,###,##0', vlSugestãoIdealSC);
  _lbeSugestaoIdealRS.Text := FormatFloat('###,###,##0', vlSugestãoIdealRS);
  _lbeSugestaoIdealEmpresa.Text := FormatFloat('###,###,##0',
    vlSugestãoIdealSC + vlSugestãoIdealRS);
end;

procedure T_frmCompras.SetCamposSugestaoIdealGrid(vlSugestãoIdealGrid,
  vlSugestãoPossivelGrid: Double);
begin
  _lbeSugestaoIdealGrid.Text := FormatFloat('###,###,##0', vlSugestãoIdealGrid);
  _lbeSugestaoPossivelGrid.Text := FormatFloat('###,###,##0',
    vlSugestãoPossivelGrid);
...
begin
  ...
  begin
    if Confirma('Deseja Realmente trocar nr. da Lista Preço?', MB_DEFBUTTON2)
      = IDYES then
...
begin
  ...
  begin
    ...
    begin
      corBarra := clTeal;
      stLocalCd := 'Posicao Estoque / CD Tubarão';
    end
    else
    begin
      corBarra := $000080FF; // $0073EAFB;//clMoneyGreen;
...
begin
  ...
  CarregaTabelaTemporaria(_cdsSugestaoCompra, 1, 'CD TUBARÃO',nrUnidadesSugeridaSC, vlSugeridoCustoSC, vtSugeridoVendaSC,
  ...
  CarregaTabelaTemporaria(_cdsExcessoEstoque, 1, 'CD TUBARÃO',
...
begin
  try
    ...
    begin
      ...
      Add('WHEN CD_EMPRESA=1 THEN ''CD TUBARÃO''');
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        Mensagem('Pedido Não pode ser cancelado' + #13 +
          'Já possui item faturado...', MB_ICONINFORMATION);
        result := false;
      end
      else
      begin
...
begin
  try
    ...
    begin
      Add('SELECT');
      Add('CASE');
      Add('WHEN VAM.CD_EMPRESA=1 THEN ''CD TUBARÃO''');
...
begin
  ...
  begin
    ...
    ELSE
      Mensagem('Produto Não encontrado !!!', 16);
  end;
...
begin
  ...
  _cdsExcessoEstoqueID_LOCAL.AsString := 'CD TUBARÃO';
  ...
  begin
    ...
    begin
      AtualizaItemPedido(nrPedidoLocal, Mercadoria.nrProduto,
        ...
        vlMediaMesSC, ' Recalculado Sugestão', PnrEmpresa);
...
begin
  ...
  begin
    ...
    begin
      Mensagem('Pedido  Já Faturado', 48);
      exit;
    end;
...
begin
  ...
  begin
    ...
    _stbCompras.Panels[1].Text := 'Recalculando Previsão de compra...' +
      FormatFloat('0000000', _cdsProduto.FieldByName('CD_PRODUTO').AsInteger) +
      ' - ' + _cdsProduto.FieldByName('NM_COMPLETO').AsString;
    _stbCompras.Panels[2].Text := 'Registro...' + FormatFloat('0000000',
      nrRegistro) + ' de ' + FormatFloat('0000000', _cdsProduto.RecordCount);
