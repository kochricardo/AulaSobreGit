...
begin
  ...
  TStringField(_cdspedido.FieldByName('APRESENTACAO_MERCADORIA')).DisplayLabel:='Apresentação Produto';
  ...
  TFloatField(_cdspedido.FieldByName('VL_UNITARIO_COMPRA')).DisplayLabel:='Pço. Lista';
  ...
  TFloatField(_cdspedido.FieldByName('VL_MEDIA_DIARIA')).DisplayLabel:='Média Vda.Dia';
  ...
  TIntegerField(_cdspedido.FieldByName('NR_PREVISAO_VENDA')).DisplayLabel:='Previsão Venda';
  ...
  TIntegerField(_cdspedido.FieldByName('PR_ESTQ_COM_PENDENCIA')).DisplayLabel:='Previsão Est.C/Pend.';
  ...
  TIntegerField(_cdspedido.FieldByName('PR_ESTQ_SEM_PENDENCIA')).DisplayLabel:='Previsão Est.S/Pend.';
