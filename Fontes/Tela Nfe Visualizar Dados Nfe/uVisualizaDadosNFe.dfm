object _frmNfeVisualizaDanfe: T_frmNfeVisualizaDanfe
  ...
  object qryconsulta_GED: TSQLQuery
    ...
    SQL.Strings = (
        ...
        'SELECT CD_FORNECEDOR, NOMP_P, DT_EMISSAO, A.DT_ATUALIZACAO DT_AT' +
        'UALIZACAO,NM_COMPRADOR_REDUZIDO, '
      
        '  DS_NFE_CHAVE,NR_NFE, CGCP_P, PC_REPASSE_ICMS,A.NR_PEDIDO_COMPR' +
        'A,UTL_COMPRESS.LZ_UNCOMPRESS(A.DS_NFE_XML) DS_NFE_XML '
      
        'FROM PRDDM.DC_NFE_COMPRA_GED A,PRDDM.DCPES,PRDDM.DC_FABRICANTE F' +
        ',PRDDM.DC_COMPRADOR_GAM C'
    ...
    Left = 176
    Top = 208
    object qryconsulta_GEDCD_FORNECEDOR: TFMTBCDField
      FieldName = 'CD_FORNECEDOR'
      Required = True
      Precision = 6
      Size = 0
    end
    object qryconsulta_GEDNOMP_P: TWideStringField
      FieldName = 'NOMP_P'
      Required = True
      FixedChar = True
      Size = 40
    end
    object qryconsulta_GEDDT_EMISSAO: TSQLTimeStampField
      FieldName = 'DT_EMISSAO'
      Required = True
    end
    object qryconsulta_GEDDT_ATUALIZACAO: TSQLTimeStampField
      FieldName = 'DT_ATUALIZACAO'
      Required = True
    end
    object qryconsulta_GEDNM_COMPRADOR_REDUZIDO: TWideStringField
      FieldName = 'NM_COMPRADOR_REDUZIDO'
      Required = True
      Size = 10
    end
    object qryconsulta_GEDDS_NFE_CHAVE: TWideStringField
      FieldName = 'DS_NFE_CHAVE'
      Required = True
      Size = 200
    end
    object qryconsulta_GEDNR_NFE: TFMTBCDField
      FieldName = 'NR_NFE'
      Required = True
      Precision = 9
      Size = 0
    end
    object qryconsulta_GEDCGCP_P: TFMTBCDField
      FieldName = 'CGCP_P'
      Required = True
      Precision = 14
      Size = 0
    end
    object qryconsulta_GEDNR_PEDIDO_COMPRA: TFMTBCDField
      FieldName = 'NR_PEDIDO_COMPRA'
      Required = True
      Precision = 6
      Size = 0
    end
    object qryconsulta_GEDDS_NFE_XML: TBlobField
      FieldName = 'DS_NFE_XML'
      BlobType = ftOraBlob
      Size = 1
    end
    object qryconsulta_GEDPC_REPASSE_ICMS: TFMTBCDField
      FieldName = 'PC_REPASSE_ICMS'
      Required = True
      Precision = 9
      Size = 6
    end
