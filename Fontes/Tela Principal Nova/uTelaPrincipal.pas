...
uses
  ...
  AppEvnts, XPStyleActnCtrls, StdStyleActnCtrls,DBClient;
...
type
  T_frmTelaPrincipal = class(TForm)
    ...
    procedure acCadastroParametroExecute(Sender: TObject);
  private
...
uses ufrmLogin, uDm, uDividiPedido, uEnvioPedido, uAplicarVerbaPedido,
  ...
  uCancelaPendenciaExcel,  uParametroCompras, uPedidoEmAnaliseApi,
  uAuxiliarCompras;
...
procedure T_frmTelaPrincipal.acCadastroParametroExecute(Sender: TObject);
begin
   Application.CreateForm(T_frmCadastroParametro, _frmCadastroParametro);

  FormPos(_frmCadastroParametro,2,1)
  ...
  begin
    ...
    begin
     try
       ...
       _cdsTemp:=DadosEmAnaliseApi(0,0);
        ...
        begin
           ...
           begin
              _frmPedidoEmAnalise._cdsPedidoemAnalise:=_cdsTemp;
                            _frmPedidoEmAnalise._cdsPedidoemAnalise.Open;
               Application.CreateForm(T_frmPedidoEmAnalise,_frmPedidoEmAnalise);
              _frmPedidoEmAnalise._cdsPedidoemAnalise:=_cdsTemp;
              _frmPedidoEmAnalise._cdsPedidoemAnalise.Open;

              _frmPedidoEmAnalise.ShowModal;
              _frmPedidoEmAnalise.free;
           end;
        end;
...
//       cdUsuarioSistema   := 3000;
  ...
  nmAplicacao := 'SisCpa MultiEmpresa - TESTE novo Versão.';
