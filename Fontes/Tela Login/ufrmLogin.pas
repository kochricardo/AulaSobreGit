   ...
   // if _dmGeral.RunQueryUsuario(0,edtLogin.Text,'') then
     ...
     begin
        StatusBar1.SimpleText:=format('Acesso: %s',['Negado']);
         Application.MessageBox('Usuário não Cadastrado.','Acesso Negado',0 + 16);
         exit;
     end;
     ...
     begin
      ...
      begin
        ...
        begin
             ...
             begin
              StatusBar1.SimpleText:=format('Acesso: %s',['Negado']);
              Application.MessageBox('Usuário não Cadastrado para acessar o programa.','Acesso Negado',0 + 16);
             end;
         ...
         begin
          StatusBar1.SimpleText:=format('Acesso: %s',['Negado']);
          Application.MessageBox('Senha Inválida.','Acesso Negado',0 + 16);
         end;
