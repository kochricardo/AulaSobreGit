...
begin
  ...
  begin
    ...
    vlPag := 1;
    Linha := 200;
    Title := 'Comparção de Venda Anual';
...
begin
  ...
  Printer.Canvas.TextOut(3100, nrLinha, 'Comparação Anual de Venda');
...
begin
  ...
  Printer.Canvas.TextOut(2500, nrLinha, 'Comparação Anual de Venda ');
