object _frmComparacaoAnualVenda: T_frmComparacaoAnualVenda
  Left = 0
  Top = 0
  Caption = 'Compara'#231#227'o Anual de Venda'
  ClientHeight = 496
  ClientWidth = 1025
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    TabOrder = 1
    object _dbgComparacaoAnual: TDBGrid
      Left = 2
      Top = 15
      Width = 1021
      Height = 376
      Align = alClient
      DataSource = _dsProdutosVenda
      ...
      TitleFont.Style = []
      OnDrawColumnCell = _dbgComparacaoAnualDrawColumnCell
    end
  end
  ...
  object _edtNumeroFornecedor: TEdit
    ...
    NumbersOnly = True
    TabOrder = 3
    OnKeyDown = _edtNumeroFornecedorKeyDown
  end
  ...
  object _cdsProdutosVenda: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 648
    Top = 48
  end
  object _dsProdutosVenda: TDataSource
    DataSet = _cdsProdutosVenda
    Left = 760
    Top = 56
  end
