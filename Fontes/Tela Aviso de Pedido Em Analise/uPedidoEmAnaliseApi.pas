...
begin
 ...
 TStringField(_cdsPedidoemAnalise.FieldByName('OBSP_P')).DisplayLabel:='Observação';
 ...
 TFloatField(_cdsPedidoemAnalise.FieldByName('VL_PEDIDO_FABR')).DisplayLabel:='Vlr.Ped.Pço Fornec.';
