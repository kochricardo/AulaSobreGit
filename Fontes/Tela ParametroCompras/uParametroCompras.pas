...
begin
  ...
  begin
    ...
    begin
        mensagem('Esta operação não pode ser realizada !!!',MB_ICONWARNING);
...
begin
  ...
  //Carregando Envio Autmatico
   ...
   if SuaVariavel='S' then
     ...
     _cbxEnvioAutomatico.ItemIndex:= _cbxEnvioAutomatico.Items.IndexOf('Não');
...
begin
  ...
  begin
    ...
    Mensagem('Email não eh valido !!!',MB_ICONWARNING);
end;
