...
type
  T_frmRelacaoNFeRecebida = class(TForm)
    GroupBox1: TGroupBox;
...
var
  _frmRelacaoNFeRecebida: T_frmRelacaoNFeRecebida;
...
procedure T_frmRelacaoNFeRecebida.ConsultaGED;
begin
...
procedure T_frmRelacaoNFeRecebida.FormClose(Sender: TObject;
...
procedure T_frmRelacaoNFeRecebida.DBGridConsultaGEDKeyDown(Sender: TObject;
...
procedure T_frmRelacaoNFeRecebida.DBGridConsultaGEDTitleClick(
  Column: TColumn);
begin
...
procedure T_frmRelacaoNFeRecebida.SAIR1Click(Sender: TObject);
begin
  close;
end;

procedure T_frmRelacaoNFeRecebida.DBGridConsultaGEDKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
  begin
...
procedure T_frmRelacaoNFeRecebida.FormShow(Sender: TObject);
begin
  Timer1.Enabled:=true;
end;

procedure T_frmRelacaoNFeRecebida.Timer1Timer(Sender: TObject);
begin
