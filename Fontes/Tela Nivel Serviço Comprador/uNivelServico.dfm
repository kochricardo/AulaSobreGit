object _frmNivelServico: T_frmNivelServico
  Left = 0
  Top = 0
  Caption = 'Nivel Servi'#231'o Comprador'
  ClientHeight = 530
  ClientWidth = 1021
  Color = clBtnFace
  ...
  object _grbNivelServico: TGroupBox
    Left = 0
    Top = 0
    Width = 1021
    Height = 417
    ...
    Caption = 'Nivel Servi'#231'o'
    TabOrder = 1
    object _dbgNivelServiço: TDBGrid
      Left = 2
      Top = 15
      Width = 1017
      Height = 400
      Align = alClient
      DataSource = _dsNivelServico
      TabOrder = 0
      ...
      TitleFont.Style = []
      OnDrawColumnCell = _dbgNivelServiçoDrawColumnCell
      OnTitleClick = _dbgNivelServiçoTitleClick
    end
  end
  ...
  object BitBtn1: TBitBtn
    ...
    Width = 153
    Height = 34
    Caption = 'Mostra Nivel Servi'#231'o'
    DoubleBuffered = True
    Glyph.Data = {
  ...
  object _chkSeparaFornecedor: TCheckBox
    Left = 160
    Top = 471
    Width = 145
    Height = 17
    Caption = 'Separa por Fornecedor'
    TabOrder = 5
  end
  ...
  object _cdsNivelServico: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 640
    Top = 80
  end
  object _dsNivelServico: TDataSource
    DataSet = _cdsNivelServico
    Left = 744
    Top = 80
  end
  object _dsFaturamentoMedio: TDataSource
    DataSet = _cdsFaturamentoMedio
    Left = 344
    Top = 80
  end
  object _cdsFaturamentoMedio: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 200
    Top = 88
