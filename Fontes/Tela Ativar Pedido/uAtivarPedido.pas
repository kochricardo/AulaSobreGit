...
begin
                    ...
                    begin
                     ...
                     begin
                      Mensagem('Pedido Já esta ativo!!!',MB_ICONWARNING);
                      exit;
                     end;
                       ...
                       begin
                           ...
                           if AtivaCapaPedido(DadosPedidoAbertuta.nrPedido,DadosPedidoAbertuta.nrOperadorLogistico,nrLeadTime,'N',DadosPedidoAbertuta.idPedidoBonificado,DadosPedidoAbertuta.nrVerba) then
                             ...
                             begin
                                 ...
                                 Mensagem('Pedido Não Ativado!!!',MB_ICONWARNING);
...
begin
 ...
 TDateField(_cdsLogPedido.FieldByName('ds_observacao')).DisplayLabel:='Observação';
