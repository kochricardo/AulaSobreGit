...
type
  T_frmCriticaPedidoNfe = class(TForm)
...
var
  _frmCriticaPedidoNfe: T_frmCriticaPedidoNfe;
...
procedure T_frmCriticaPedidoNfe.MudaStatusCritica(statusCritica:string);
var
  sql : string;
begin
...
procedure T_frmCriticaPedidoNfe.AtualizaRelacaoCritica;
begin
...
procedure T_frmCriticaPedidoNfe.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=cafree;
end;

procedure T_frmCriticaPedidoNfe.inativarCritica(nrCritica:integer);
var
  sqlDados: TSQLQuery;
  i: integer;
...
function T_frmCriticaPedidoNfe.isStatusNFeFaturada(dsChave:string):Boolean;
var
  sqlDados: TSQLQuery;
begin
  sqlDados:=TSQLQuery.Create(nil);
...
procedure T_frmCriticaPedidoNfe.verificarNFeFaturada;
begin
...
procedure T_frmCriticaPedidoNfe.RGroupStatusCriticaClick(Sender: TObject);
begin
  AtualizaRelacaoCritica;
  //verificarNFeFaturada;
end;

procedure T_frmCriticaPedidoNfe.DbGridRelacaoCriticaKeyPress(
...
procedure T_frmCriticaPedidoNfe.DbGridRelacaoCriticaTitleClick(
  Column: TColumn);
begin
...
procedure T_frmCriticaPedidoNfe.FormActivate(Sender: TObject);
begin
...
procedure T_frmCriticaPedidoNfe.setGridRelacaodeCritica;
begin
...
procedure T_frmCriticaPedidoNfe.FormCreate(Sender: TObject);
begin
setGridRelacaodeCritica;
end;
