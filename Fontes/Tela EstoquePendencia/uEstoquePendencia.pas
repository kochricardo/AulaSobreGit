...
begin
If _cdsEstoquePendencia.FieldByName('CD_COMPRADOR').AsInteger=1  then // condição
begin
...
If _cdsEstoquePendencia.FieldByName('CD_COMPRADOR').AsInteger=2  then // condição
begin
  _dbgEstoque.Canvas.Font.Color:=clBlack ; // coloque aqui a cor desejada
  _dbgEstoque.Canvas.Brush.Color:= clMoneyGreen;
end;
If _cdsEstoquePendencia.FieldByName('CD_COMPRADOR').AsInteger=3  then // condição
begin
  _dbgEstoque.Canvas.Font.Color:= clBlack; // coloque aqui a cor desejada
  _dbgEstoque.Canvas.Brush.Color:= clAqua;
end;
If _cdsEstoquePendencia.FieldByName('CD_COMPRADOR').AsInteger=4  then // condição
begin
  _dbgEstoque.Canvas.Font.Color:= clblack; // coloque aqui a cor desejada
  _dbgEstoque.Canvas.Brush.Color:= clYellow;
end;
If _cdsEstoquePendencia.FieldByName('CD_COMPRADOR').AsInteger=5  then // condição
begin
  _dbgEstoque.Canvas.Font.Color:= clBlack; // coloque aqui a cor desejada
  _dbgEstoque.Canvas.Brush.Color:= clskyblue;
end;
If _cdsEstoquePendencia.FieldByName('CD_COMPRADOR').AsInteger=6  then // condição
begin
  _dbgEstoque.Canvas.Font.Color:= clwhite; // coloque aqui a cor desejada
  _dbgEstoque.Canvas.Brush.Color:= clHotLight;
end;
If _cdsEstoquePendencia.FieldByName('CD_COMPRADOR').AsInteger=7  then // condição
begin
  _dbgEstoque.Canvas.Font.Color:= clWhite; // coloque aqui a cor desejada
  _dbgEstoque.Canvas.Brush.Color:= clRed;
end;
If _cdsEstoquePendencia.FieldByName('CD_COMPRADOR').AsInteger=8  then // condição
begin
  _dbgEstoque.Canvas.Font.Color:= clblack; // coloque aqui a cor desejada
  _dbgEstoque.Canvas.Brush.Color:= clInactiveBorder;
end;
If _cdsEstoquePendencia.FieldByName('CD_COMPRADOR').AsInteger=9  then // condição
begin
  _dbgEstoque.Canvas.Font.Color:= clblack; // coloque aqui a cor desejada
  _dbgEstoque.Canvas.Brush.Color:= clskyblue;
end;
If _cdsEstoquePendencia.FieldByName('CD_COMPRADOR').AsInteger=10  then // condição
begin
  _dbgEstoque.Canvas.Font.Color:= clBLACK; // coloque aqui a cor desejada
  _dbgEstoque.Canvas.Brush.Color:= clFuchsia;
end;
If _cdsEstoquePendencia.FieldByName('CD_COMPRADOR').AsInteger=11  then // condição
begin
  _dbgEstoque.Canvas.Font.Color:= clWhite; // coloque aqui a cor desejada
  _dbgEstoque.Canvas.Brush.Color:= clMaroon;
end;
If _cdsEstoquePendencia.FieldByName('CD_COMPRADOR').AsInteger=12  then // condição
begin
  _dbgEstoque.Canvas.Font.Color:= clBLACK; // coloque aqui a cor desejada
...
begin
   ...
   begin
    ...
    TFloatField(_cdsEstoquePendencia.FieldByName('VL_PEND_PCO_CUSTO')).DisplayLabel:='Vlr.Pend.(Pço Custo)';
    ...
    TFloatField(_cdsEstoquePendencia.FieldByName('VL_PEND_PCO_FABRICA')).DisplayLabel:='Vlr.Pend.(Pço.Vda)';
