...
begin
 ...
 TStringField(_cdsProdutos.FieldByName('APRESENTACAO')).DisplayLabel:='Apresentação';
...
//      ,
 ...
 TFloatField(_cdsProdutos.FieldByName('PRECO_FABRICA')).DisplayLabel:='Pço.Fornecedor';
 ...
 TStringField(_cdsProdutos.FieldByName('CLASSIFICACAO')).DisplayLabel:='Classificação';
 TStringField(_cdsProdutos.FieldByName('CLASSIFICACAO')).DisplayWidth:=25;

 TStringField(_cdsProdutos.FieldByName('SUB_CLASSIFICACAO')).DisplayLabel:='Sub.Classificação';
 ...
 TFloatField(_cdsProdutos.FieldByName('VL_PRECO_VENDA')).DisplayLabel:='Pço.Venda';
