...
uses
  ...
  Grids, DBGrids, DB, DBClient,DateUtils, ComCtrls, uAuxiliarCompras;
type
 TDadosMedia = record
  vlMediaMes :Double;
  vlMediaDia :Double;
...
begin
 ...
 _cdsPendencia := AbrePendenciaLaboratorioNova(NrFornecedor);
...
function T_frmComprasNova.setPendenciaCD(nrProduto,
                                        cdEmpresa: Integer): TDadosPendenciaPedido;
begin
  result.qtPedido     := 0;
  result.qtAtendida   := 0;
